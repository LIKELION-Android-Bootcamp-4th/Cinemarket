import 'package:cinemarket/features/cart/widgets/cart_bottom_bar.dart';
...
class _CartScreenState extends State<CartScreen> {
  List<CartItem> cartItems = []; // 임시로 비워둠, 상품 있으면 여기에 추가
  ...
  void initState() {
    ...
    cartItems = [
      CartItem(name: '영화 굿즈 인형', quantity: 1, price: 15000, isSelected: true),
